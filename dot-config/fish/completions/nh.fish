...
complete -c nh -n "__fish_seen_subcommand_from sync" -l remove -d "Find tracked-but-not-installed items"
complete -c nh -n "__fish_seen_subcommand_from sync" -l reset -d "Clear skip list and run sync"
