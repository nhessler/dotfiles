...
complete -c nh -n "__fish_seen_subcommand_from sync; and not __fish_seen_subcommand_from keep remove reset" -a keep -d "Find installed-but-not-tracked items (default)"
complete -c nh -n "__fish_seen_subcommand_from sync; and not __fish_seen_subcommand_from keep remove reset" -a remove -d "Find tracked-but-not-installed items"
complete -c nh -n "__fish_seen_subcommand_from sync; and not __fish_seen_subcommand_from keep remove reset" -a reset -d "Clear skip list"
complete -c nh -n "__fish_seen_subcommand_from sync" -s o -xa "brew cask mas asdf emacs" -d "Only run one category"
